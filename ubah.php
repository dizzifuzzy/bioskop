    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="card-body">
          ...
          $cek_password = $conn->query("SELECT * FROM customer WHERE id_customer ='$id_customer'");
          $cekp = $cek_password->fetch_assoc();
          $user_password = $cekp['password_customer'];
          if(password_verify($plama,$user_password)){
            $submit = $conn->query("UPDATE customer SET password_customer='$encryptpbaru' WHERE id_customer='$id_customer'");
