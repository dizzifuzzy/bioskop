    ...
    <div class="container">
      ...
      <form method="post" action="" class="form-horizontal">
        ...
        if($_POST){
          ...
          $phone = $_POST['notelp'];
          $sex   = $_POST['sex'];
          $cek_email = $conn->query("SELECT * FROM customer WHERE email_customer ='".$email."'");
          $has    = $cek_email->fetch_array();
          $cek_username = $conn->query("SELECT * FROM customer WHERE username_customer ='".$username."'");
          ...
          elseif($hasi){
            ...
            echo '<div class="alert alert-success">Sukses...Silahkan ke halaman login</div>';
                $daftar = "INSERT INTO customer (id_customer,fname_customer,lname_customer,jk_customer,username_customer,password_customer,email_customer,phone_customer) VALUES (NULL,'$fname','$lname','$sex','$username','$encrypt','$email','$phone')";
